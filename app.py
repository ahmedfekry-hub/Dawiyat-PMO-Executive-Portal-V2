...
def main() -> None:
    ...
    with st.sidebar:
        st.markdown(
            """
            <div class="v604-sidebar-brand">
                <div class="v604-brand-icon">📊</div>
                <div>
                    <div class="v604-brand-title">PMO Portal</div>
                    <div class="v604-brand-subtitle">Executive Dashboard</div>
                </div>
            </div>
            """,
            unsafe_allow_html=True,
